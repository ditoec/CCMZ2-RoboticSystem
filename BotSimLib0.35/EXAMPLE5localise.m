...
botSim = BotSim(map,[1,0.1,0.05]);  %sets up a botSim object a map, and debug mode on.
botSim.drawMap();
drawnow;
...
resultsDis =  distance(botSim.getBotPos(), returnedBot.getBotPos())
figure(1)
text(80,-8,['Time:',num2str(resultsTime)])
text(80, -13,['Dist:',num2str(resultsDis)])
drawnow;